...
class FTDrawer {
    ...
    constructor(
        ...
        //this.tooltip(FTDrawer.default_tooltip_func); TO-CHANGE: Re-enable tooltip with additional info
    ...
    static default_node_label_func(node) {
        ...
        if (node.is_union()) return;
        return node.get_name() //+ TO-CHANGE Temporarily remove additional info
